...
scoutlet 采用 [GNU Affero General Public License v3](LICENSE) 授权。`src/scoutlet/engines/` 下的引擎代码衍生自 [SearXNG](https://github.com/searxng/searxng)(同样采用 AGPL-3.0)。第三方致谢与归属详见 [NOTICE](NOTICE)。
