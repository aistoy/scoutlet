"""Sogou Videos - adapted from SearXNG."""
...
logger = logging.getLogger("scoutlet.engines.sogou_videos")
...
def request(query, params):
    query_params = {"page": params["pageno"], "pagesize": 10, "query": query}
